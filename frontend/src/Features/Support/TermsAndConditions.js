...
const TermsAndConditions = () => (
  <div style={{ padding: "1rem" }}>
    ...
    <p><strong>Last updated on May 1, 2025</strong></p>

    <p>
      For the purpose of these Terms and Conditions, the term "we", "us", "our" used anywhere on this page shall mean <strong>GetFit</strong>, whose registered/operational office is <em>4-1-121/129, VST Colony, Nacharam, Uppal, Hyderabad, Telangana 500076</em>. 
    ...
    <ul>
      ...
      <li>
        You may not create a link to our website from another website or document without GetFit’s prior written consent.
      </li>
      <li>
